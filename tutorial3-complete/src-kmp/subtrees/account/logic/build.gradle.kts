...
base.archivesName.set("account-logic")
...
kotlin {
  ...
  sourceSets {
    commonMain.dependencies {
      ...
      // The auth port, and the child level whose delegate events this one receives.
      api(project(":ports"))
...
ksp {
  arg("kspMocksTargets", "dev.modaal.foyer.account.AccountEnvironment")
}
